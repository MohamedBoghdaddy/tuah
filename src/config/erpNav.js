...
export const ERP_NAV_GROUPS = [
  ...
  },
  {
    ...
    icon: "inventory_2",
    items: [
      { label: "Overview", icon: "dashboard", href: "/admin/inventory/overview", permission: "inventory.read" },
      { label: "Warehouses", icon: "warehouse", href: "/admin/inventory/warehouses", permission: "inventory.read" },
      { label: "Stock", icon: "inventory", href: "/admin/inventory/stock", permission: "inventory.read" },
      { label: "Transfers", icon: "sync_alt", href: "/admin/inventory/transfers", permission: "inventory.read" },
      { label: "Receipts", icon: "move_to_inbox", href: "/admin/inventory/receipts", permission: "inventory.read" },
      { label: "Adjustments", icon: "rule", href: "/admin/inventory/adjustments", permission: "inventory.read" },
      { label: "Replenishment", icon: "autorenew", href: "/admin/inventory/replenishment", permission: "inventory.read" },
    ],
  },
  {
    key: "purchasing",
