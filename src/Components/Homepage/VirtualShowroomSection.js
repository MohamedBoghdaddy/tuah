...
const VirtualShowroomSection = () => (
  <section className="tuwa-showroom" aria-labelledby="showroom-heading">
    <div className="tuwa-home-container tuwa-showroom-grid">
      <div className="tuwa-showroom-copy">
        ...
        <Link to="/virtual-showroom" className="tuwa-home-light-btn">
          Explore Showroom
          <span className="material-symbols-outlined">view_in_ar</span>
        </Link>
      </div>

      <div className="tuwa-showroom-image">
